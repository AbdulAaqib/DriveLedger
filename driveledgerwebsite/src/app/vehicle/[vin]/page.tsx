          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-muted-foreground">Last Fault</label>
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-sm text-muted-foreground">Blockchain Token ID</label>
                  <p className="text-lg font-mono">#1234</p>
                </div>
                <div>
                  <label className="text-sm text-muted-foreground">IPFS Link</label>
                  <a 
                    href="#" 
                ...
                <div>
                  <label className="text-sm text-muted-foreground">NFT Preview</label>
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">Cylinder 2</p>
                    </div>
                    <div>
                  ...
                  <div className="mt-4 pt-4 border-t grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-muted-foreground">Key Sensors</p>
