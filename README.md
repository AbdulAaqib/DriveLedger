...
| Technology          | Logo                                                                                                      |                                         |
| ------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| **python-obd**      | ![oaicite:6](https://raw.githubusercontent.com/brendan-w/python-OBD/master/docs/_static/logo.png)         |                                         |
| **scikit-learn**    | ![oaicite:8](https://scikit-learn.org/stable/_static/scikit-learn-logo-small.png)                         |                                         |
| **TensorFlow Lite** | ![oaicite:10](https://www.tensorflow.org/images/tf_logo_social.png)                                       |                                         |
| **web3.py**         | ![oaicite:12](https://raw.githubusercontent.com/ethereum/web3.py/master/docs/_static/img/web3py-logo.png) |                                         |
| **Supabase**        | ![oaicite:14](https://supabase.com/docs/img/supabase-logo.svg)                                            |                                         |
| **React**           | ![oaicite:16](https://reactjs.org/logo-og.png)                                                            |                                         |
| **TypeScript**      | ![oaicite:18](https://www.typescriptlang.org/icons/icon-48x48.png)                                        |                                         |
| **Vercel**          | ![oaicite:20](https://assets.vercel.com/image/upload/v1607554385/repositories/vercel/logo.png)            |                                         |
| **Docker**          | ![oaicite:22](https://www.docker.com/wp-content/uploads/2022/03/Moby-logo.png)                            | ([PyPI][1], [Vercel][2], [CleanPNG][3]) |
